...
{
    public partial class MLOrderClassificationModel
    {
        /// <summary>
        /// model input class for MLOrderClassificationModel.
        /// </summary>
        ...
        /// <summary>
        /// model output class for MLOrderClassificationModel.
        /// </summary>
        ...
        {
            var modelPath = Task.Run(async () => await Package.Current.InstalledLocation.GetFileAsync(@"Assets\ML\MLOrderClassificationModel.mlnet")).Result;
