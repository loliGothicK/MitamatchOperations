...
)
{
    ...
    [
        ...
        new Costume(
            ...
            "黄昏の聖装",
            new SpecialRangeCostume(15),
            new RareSkill("エルヴンレジスタ", "一定時間、味方全体の攻撃力/防御力をアップする。さらに、CHARM特性のメモリアスキル効果UP、支援、妨害効果をアップする。※「レジスタS」より効果時間が長い。"),
            [
                new Common([new LilySpDef(150)]),
                new Unique([new Calibration(3)]),
                new Common([new LilyHp(500)]),
        ...
        new Costume(
            ...
            "黄昏の聖装",
            new AssistCostume(15),
            new RareSkill("エルヴンヘリオスフィア", "一定時間、敵全体の攻撃力/防御力を大ダウンし、味方全体の防御力をアップする。※「ヘリオスフィアS」より攻撃力/防御力の減少量が大きい。"),
            [
                new Common([new LilySpDef(150)]),
                new Unique([new Calibration(3)]),
                new Common([new LilyHp(250)]),
