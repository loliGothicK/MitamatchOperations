...
public class Costume
{
    ...
    )
    {
        ...
        public readonly LilySkill IntoLilySkill => kind switch
        {
            "common" => new Common([.. skills.Select<SkillItemDto, LilySkill>(skill => skill.type switch
            {
                "calibration" => new Calibration(skill.value),
                "ATK" => new LilyAtk((int)skill.value),
                "DEF" => new LilyDef((int)skill.value),
                "Sp.ATK" => new LilySpAtk((int)skill.value),
                "Sp.DEF" => new LilySpDef((int)skill.value),
                "HP" => new LilyHp((int)skill.value),
                _ => throw new NotImplementedException($"{skill.type}"),
            })]),
            "unique" => new Unique([.. skills.Select<SkillItemDto, LilySkill>(skill => skill.type switch
            {
                "calibration" => new Calibration(skill.value),
                "ATK" => new LilyAtk((int)skill.value),
                "DEF" => new LilyDef((int)skill.value),
